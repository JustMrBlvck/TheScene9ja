...
function Footer() {
  return (
    <div>
           <div className=' h-[70px] bg-[#070711] hidden lg:grid grid-cols-[30%,70%] mt-20'>
           ...
           <div className='h-[90px] bg-[#1A1B1D] text-white font-Custom font-medium flex justify-evenly items-center mt-20 lg:hidden'>
