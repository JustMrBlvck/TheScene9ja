  ...
  return (
    <div>
       ...
       <h1 className='font-bold text-PrimaryColor text-2xl border-l-[4px] border-[#D7AE61] p-2 mx-5 mt-5 md:mt-0 lg:mx-28 lg:mt-0'>NEWS</h1>
           ...
           <div className='h-[790px] md:static lg:sticky lg:top-0'>
              <div className='lg:ml-12'>
                <h1 className='font-Custom font-bold text-[25px] ml-[-4px]'>Latest Posts</h1>
                    {LatestNews.map((LatestNewsS, index)=>(
                      <div key={index} className='h-[200px] border-b-[2px] border-[#8080802f] grid grid-cols-[30%,70%] md:h-[240px] md:grid md:grid-cols-[30%,70%] md:border-b-[.2px] md:border-[#8080802f] lg:h-[100px] lg:grid lg:grid-cols-[25%,75%] lg:mt-4 lg:border-b-[.2px] lg:border-[#8080802f]'>
                          <Link className='flex items-center justify-start bg-[]'>
                                <img src={LatestNewsS.Image} className='h-[80px] w-[100px]'/>
                          </Link>
